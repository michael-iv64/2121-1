  ...
  class Orb{
    ...
    refresh() {
      ...
      if (distToC > ph - 1 || sin > 0) { //минус 1 чтобы убрать мерцание(неточности вычмслений)
        ...
        this.angle = (this.angle + this.velocity/10) % 360;
    ...
    let orbsList = [];
      ...
      let answers = this.props.knowledge[0].questions[1].answers
  ...
  setPointsHandler = () => {
    ...
    render(){
        ...
        <div className={styles.topMenu}><h3> <img className={styles.icon1} alt="solar" src={homerFace} title='SolarSystem'/>&emsp;  
          ...
          {/*  --- questions */}
        <div className={`${styles.topMenu} ${styles.bottom} ` }><h3> Вопрос № &emsp; {this.props.knowledge[0].questions[1].question}  <img className={styles.icon1} alt="solar" src={robotFace} title='SolarSystem'/>&emsp;  
